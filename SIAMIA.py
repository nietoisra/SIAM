## python -m streamlit run C:\Users\Nieto\Desktop\Dash_IA\Dash_Med_7.py
        ...
        if not nombre or not uploaded_file:
            ...
            try:
                ...
                if not {'Tiempo', 'Acc X', 'Acc Y', 'Acc Z'}.issubset(data.columns):
                    ...
                    # Simular proceso largo con barra de progreso
                    ...
                    for i in range(100):
                        ...
                        time.sleep(0.03)  # Simulación de proceso (reemplaza esto por tu procesamiento real)

                        status_text.text("✅ ¡Proceso completado!")
                    st.success("Análisis completado. Puedes visualizar los resultados a continuación.")
